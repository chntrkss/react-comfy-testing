    ...
    return (
        <Wrapper>
            <div className="btn-container">
                <button className={`${grid_view ? "active" : null}`} onClick={setGridView} disabled={grid_view}>
                    <BsFillGridFill />
                </button>
                <button className={`${!grid_view ? "active" : null}`} onClick={setListView} disabled={!grid_view}>
                    <BsList />
                </button>
            </div>
